...
#log{
    ...
    width: 80px;border: 0;padding: 10px 0;margin-top: 10px;margin-left: -2px;
    border-radius: 5px;background-color: #DC143C;font-family: Cursive,Lucida Handwriting;
}
</style>
</head>
<body>
...
<input id="Pass" type="password" name="pw"/><br/>  
